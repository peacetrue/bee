...
使用网站 https://cloudconvert.com/svg-to-ico[cloudconvert^]，
转换 logo.svg 为 favicon.ico 和 logo192.png、logo512.png。
...
[source%nowrap,tsx]
----
include::example$frontend/src/compontents/NavMenu.tsx[]
----
